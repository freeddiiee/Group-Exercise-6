...
<head>
  ...
  <title>Kampon ni Aries Sign Up</title>
  <link rel="icon" type="image/x-icon" href="images/favicon.ico" />
  <link rel="stylesheet" href="signupstyles.css" />
  <!-- <script>
      function additionalinfo() {
        let role = promt("Please enter your role: ");
      }
    </script> -->
</head>
<script>
...
<body>
  <div class="form-container">
    ...
    <div class="icon">
      <!-- You can replace the div below with an actual image or icon if needed -->
    ...
    <p class="login">
      ...
      <a hrel="noopener noreferrer" href="login.php">Log in</a>
    </p>
  </div>
</body>
